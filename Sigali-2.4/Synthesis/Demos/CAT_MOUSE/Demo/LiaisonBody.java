...
public class LiaisonBody {
    ...
    public void Draw_Cat(int Pos_Cat[]){ vt.Draw_Cat(Pos_Cat);}
    public void Draw_Mouse(int Pos_Mouse[]){ vt.Draw_Mouse(Pos_Mouse);}
    public void Draw_Door_Cat(int Door_Cat[]){ vt.Draw_Door_Cat(Door_Cat);}
    public void Draw_Door_Mouse(int Door_Mouse[]){ vt.Draw_Door_Mouse(Door_Mouse);}
    public void Draw_Conflict(int Conflict){ vt.Draw_Conflict(Conflict);}
