...
public class InteResolv {
    ...
    static Font fontSelected; //fonte qui sera selectionnee
	...
	bouton.changCoulFond(Bouton.coulChoixPossible);
    }
    ...
    static void creation_fen(){	
        fontSelected = new Font ("Helvetica",Font.PLAIN,10); 
	...
	if (!ListEntrees.Incont.isVide()) {
	    ...
	    fenIncont.setFont(fontSelected); 
	    gbl = new GridBagLayout(); gbc = new GridBagConstraints();
	    gbc.insets = new Insets(0,0,0,0);
	    gbc.fill = GridBagConstraints.BOTH;
