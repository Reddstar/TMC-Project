...
public class LiaisonBody {
    ...
    public void Draw(boolean  Flow_Pump, boolean  Flow_Valve2, boolean  Valve2,boolean Valve3, boolean Valve4){ vt.Draw(  Flow_Pump,Flow_Valve2,Valve2,Valve3,Valve4);}

    public void Draw_State(boolean X0,boolean X1,boolean X2,boolean X3,boolean X4,boolean X5,boolean X6,boolean Flow){vt.Draw_State(X0,X1,X2,X3,X4,X5,X6,Flow);}
