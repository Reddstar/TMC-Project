...
variable::variable(integer num, iri_tdd_manager tddm)
{
  etat = INDETER;
...
//variable::set_perm(int valeur_init)
//{
//  etat = PERM;
//  valeur = valeur_init;
//}
...
// instancier_par_defaut
//----------------------
// associe la valeur 0 a une variable non instantiee
void variable::instancier_par_defaut()
{
  if (etat != INST)
    {
      etat = INST;
      valeur = 0;
      val_possible = S_ABSENT;
    }
}
...
integer variable::set_sol(val_perm vp)
{
  integer nbsol, result;
