...
/* opcodes: operations unaires code inferieur a 100
   ...
   GD 18/09/2008 : à vérifier : les op. unaires n'ont plus de code
   mais sont des pointeurs vers des tableaux (image de l'op.). On peut
   peut-être se passer de cette contrainte, 
==================================================*/
...
/* 2ème opérande de type var_assoc */
...
struct tdd_manager_
{
  ...
  integer reorder;                /* methode de reordonnancement 0:interdit, 1:w3, 2:sift */
